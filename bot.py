...
COMPANY_KEYWORDS = [
    ...
    "חברת ניהול צפת",
    "חברת ניהול קריית גת",
    "חברת ניהול קריית שמונה",
    "חברת ניהול נהריה",
    "חברת ניהול עכו",
    "חברת ניהול חדרה",
    "חברת ניהול רהט",
    "חברת ניהול דימונה",
    "חברת ניהול אום אל פחם",
    "חברת ניהול כרמיאל",
    "חברת ניהול יבנה",
    "חברת ניהול לוד",
    "חברת ניהול גבעתיים",
    "חברת ניהול קריית אונו",
    "חברת ניהול פתח תקווה",
    "חברת ניהול אור יהודה",
    "חברת ניהול קריית ביאליק",
    "חברת ניהול קריית ים",
    "חברת ניהול קריית מוצקין",
    "חברת ניהול קריית אתא",
    "חברת ניהול מעלה אדומים",
    "חברת ניהול ביתר עילית",
    "חברת ניהול אלעד",
    "חברת ניהול ראש העין",
    "חברת ניהול הוד השרון",
    "חברת ניהול כפר יונה",
    "חברת ניהול נס ציונה",
    "חברת ניהול גדרה",
    "חברת ניהול זכרון יעקב",
    "חברת ניהול טירת כרמל",
    "חברת ניהול מגדל העמק",
    "חברת ניהול שפרעם",
    "חברת ניהול סחנין",
    "חברת ניהול ירוחם",
    "חברת ניהול מצפה רמון",
    "חברת ניהול אופקים",
    "חברת ניהול נתיבות",
    "חברת ניהול שדרות",
    # סוגי חברות
